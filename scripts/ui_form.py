...
#if QT_CONFIG(tooltip)
        self.btn_home.setToolTip(QCoreApplication.translate("MainWindow", u"Visit the Coopertronic website.", None))
#endif // QT_CONFIG(tooltip)
        self.btn_home.setText(QCoreApplication.translate("MainWindow", u"Home Page", None))
#if QT_CONFIG(tooltip)
        self.btn_setup.setToolTip(QCoreApplication.translate("MainWindow", u"Setup your PC from common templates.", None))
#endif // QT_CONFIG(tooltip)
        self.btn_setup.setText(QCoreApplication.translate("MainWindow", u"Setup", None))
#if QT_CONFIG(tooltip)
        self.btn_help.setToolTip(QCoreApplication.translate("MainWindow", u"Get help with different things.", None))
#endif // QT_CONFIG(tooltip)
        self.btn_help.setText(QCoreApplication.translate("MainWindow", u"Help", None))
#if QT_CONFIG(tooltip)
        self.btn_how.setToolTip(QCoreApplication.translate("MainWindow", u"Watch videos tutorials.", None))
#endif // QT_CONFIG(tooltip)
        self.btn_how.setText(QCoreApplication.translate("MainWindow", u"How To", None))
#if QT_CONFIG(tooltip)
        self.btn_install.setToolTip(QCoreApplication.translate("MainWindow", u"Get new apps for your PC.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.btn_settings.setToolTip(QCoreApplication.translate("MainWindow", u"Change the way your PC works.", None))
#endif // QT_CONFIG(tooltip)
